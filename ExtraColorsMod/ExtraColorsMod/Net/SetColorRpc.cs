using Hazel;
using ExtraColorsMod.Extensions;
using Reactor;
...
namespace ExtraColorsMod.Net
{
    ...
    public class SetColorRpc : PlayerCustomRpc<ExtraColorsModPlugin, SetColorRpc.Data>
    {
        public SetColorRpc(ExtraColorsModPlugin plugin, uint id) : base(plugin, id) {}
